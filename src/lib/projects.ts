...
export async function fetchProjects(): Promise<Array<Project> | null> {
	console.log('here');
	// const response = await fetch('https://api.github.com/users/stoneC0der/repos', {
	// 	headers: {
	...
	// const projectPosts = rawProjectPosts as Array<Project>;
	return rawProjectPosts as Array<Project>;

	// const projects: Array<Project> = projectPosts
	// 	.map((repo) => {
	// 		console.log(repo);
